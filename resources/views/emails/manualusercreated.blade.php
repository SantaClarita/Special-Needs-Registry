          ...
          <table cellpadding="0" cellspacing="0" border="0">
            <tr>
              <td width="587" valign="top" id="main">
                <div mc:edit="main">
                  <h1 style="margin:0;">Admin has created a user account for you: {{$user_fname.' '.$user_lname}} ({{$user_email}})</h1>
                  <p>
                    <a href="{{ url('/password/reset/') }}">Reset the password</a> with the givin email to get access.<br>
                    If this was a mistake, please contact the <a href="mailto:{{ config('app.adminEmail') }}">admin</a>.
                  </p>
                </div>
              </td>
            </tr>
