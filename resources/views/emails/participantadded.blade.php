          ...
          <table cellpadding="0" cellspacing="0" border="0">
            <tr>
              <td width="587" valign="top" id="main">
                <div mc:edit="main">
                  <h1 style="margin:0;">{{$fname.' '.$middleinitial.' '.$lname}} Participants Information</h1>
                  <p>
                    Profile: <a href="{{ url('/participants/profile/'.$id) }}">Profile</a><br>
                    ID: <a href="{{ url('/participants/ID/'.$id) }}">View ID</a><br>
                    Please feel free to print the ID and/or Profile.
                  </p>
            </div>
          </td>
        </tr>
